...
static struct perf_event armv8_events[] = {
	...
	PERF_EVENT(PERF_TYPE_HARDWARE, PERF_COUNT_HW_CACHE_REFERENCES, 		"cache-refs"),
	PERF_EVENT(PERF_TYPE_HARDWARE, PERF_COUNT_HW_CACHE_MISSES, 		"cache-misses"),
	PERF_EVENT(PERF_TYPE_HARDWARE, PERF_COUNT_HW_BRANCH_INSTRUCTIONS, 	"branch-pred"),
	PERF_EVENT(PERF_TYPE_HARDWARE, PERF_COUNT_HW_BRANCH_MISSES, 		"branch-misses"),
	PERF_EVENT(PERF_TYPE_SOFTWARE, PERF_COUNT_SW_PAGE_FAULTS, 		"page-faults"),
	...
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_PMUV3_PERFCTR_LD_RETIRED, 		""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_PMUV3_PERFCTR_ST_RETIRED, 		""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_PMUV3_PERFCTR_BR_IMMED_RETIRED, 	""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_PMUV3_PERFCTR_BR_RETURN_RETIRED, 	""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_PMUV3_PERFCTR_UNALIGNED_LDST_RETIRED, 	""),
	*/

	
	/* exceptions */
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_PMUV3_PERFCTR_EXC_TAKEN, 		""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_PMUV3_PERFCTR_EXC_RETURN, 		""),
	/*
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_IMPDEF_PERFCTR_EXC_UNDEF, 		""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_IMPDEF_PERFCTR_EXC_SVC, 		""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_IMPDEF_PERFCTR_EXC_PABORT, 		""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_IMPDEF_PERFCTR_EXC_DABORT, 		""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_IMPDEF_PERFCTR_EXC_IRQ, 		""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_IMPDEF_PERFCTR_EXC_FIQ, 		""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_IMPDEF_PERFCTR_EXC_SMC, 		""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_IMPDEF_PERFCTR_EXC_HVC, 		""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_IMPDEF_PERFCTR_EXC_TRAP_PABORT, 	""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_IMPDEF_PERFCTR_EXC_TRAP_DABORT, 	""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_IMPDEF_PERFCTR_EXC_TRAP_OTHER, 		""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_IMPDEF_PERFCTR_EXC_TRAP_IRQ, 		""),
	PERF_EVENT(PERF_TYPE_RAW, ARMV8_IMPDEF_PERFCTR_EXC_TRAP_FIQ, 		""),
	*/
};
