...
static struct perf_event orin_events[] = {
	...
	PERF_RAW_EVENT("arm_dsu_0/bus_access", NULL),
	PERF_RAW_EVENT("arm_dsu_0/bus_cycles", NULL),
	PERF_RAW_EVENT("arm_dsu_0/cycles", NULL),
	...
	PERF_RAW_EVENT("arm_dsu_0/memory_error", NULL),
	PERF_RAW_EVENT("scf_pmu/bus_access", NULL),
	PERF_RAW_EVENT("scf_pmu/bus_access_normal", NULL),
	PERF_RAW_EVENT("scf_pmu/bus_access_not_shared", NULL),
	PERF_RAW_EVENT("scf_pmu/bus_access_periph", NULL),
	PERF_RAW_EVENT("scf_pmu/bus_access_rd", NULL),
	PERF_RAW_EVENT("scf_pmu/bus_access_shared", NULL),
	PERF_RAW_EVENT("scf_pmu/bus_access_wr", NULL),
	PERF_RAW_EVENT("scf_pmu/bus_cycles", NULL),
